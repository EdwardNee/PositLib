...
/**
 * Класс для проведения бенчмарков операции вычитания.
 */
...
public class MinusBenchmark {
    ...
    /**
     * Бенчмарк-метод операции вычитания Posit.
     */
    @Benchmark
    @Fork(value = 1, warmups = 0)
    @Warmup(iterations = 2, time = 1)
    @Measurement(time = 1000, iterations = 5, timeUnit = TimeUnit.MILLISECONDS)
    public Posit minusPosit(){
        return posit1.minus(posit2);
    }

    /**
     * Бенчмарк-метод операции вычитания float.
     */
    @Benchmark
    @Fork(value = 1, warmups = 0)
    @Warmup(iterations = 2, time = 1)
    @Measurement(time = 1000, iterations = 5, timeUnit = TimeUnit.MILLISECONDS)
    public float minusFloat(){
